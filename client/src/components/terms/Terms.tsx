    ...
    <section className=" mx-auto bg-gray-300 ">
      ...
      <div className="lg:w-[72rem] sm:w-[50rem] mx-auto bg-gray-300">
        ...
        <p>
          ...
          use of Noted's Website, located at Noted@chrisDev.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Noted if you do not agree to take
        ...
        <p>
          Unless otherwise stated, Noted and/or its licensors own the
          intellectual property rights for all material on Noted. All
          intellectual property rights are reserved. You may access this from
          Noted for your own personal use subjected to restrictions set in these
        ...
        <p>
          ...
          Noted does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and
          opinions of Noted,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, Noted shall not be liable for
        ...
        <p>
          ...
          sending an e-mail to Noted. Please include your name, your
