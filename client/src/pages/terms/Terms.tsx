  ...
  return (
    <section className="container">
      ...
      <p>
        ...
        of Noted's Website, located at Noted@chrisDev.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Noted if you do not agree to take all
      ...
      <p>
        We employ the use of cookies. By accessing Noted, you agreed to use
        cookies in agreement with the Noted's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Noted and/or its licensors own the intellectual
        property rights for all material on Noted. All intellectual property
        rights are reserved. You may access this from Noted for your own
      ...
      <p>You must not:</p>
      <ul>
        <li>Republish material from Noted</li>
        <li>Sell, rent or sub-license material from Noted</li>
        <li>Reproduce, duplicate or copy material from Noted</li>
        <li>Redistribute content from Noted</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Noted
        ...
        of Noted,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Noted shall not be liable for the Comments
      ...
      <p>
        Noted reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Noted a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Noted; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Noted. Please include your name, your organization name,
      ...
      <p>
        No use of Noted's logo or other artwork will be allowed for linking
