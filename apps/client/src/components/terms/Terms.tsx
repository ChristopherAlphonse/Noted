        ...
        <section className="bg-gradient-to-b">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              <div className="lg:w-[72rem] sm:w-[50rem] mx-auto ">
                <h2>
                ...
                <p>
                  ...
                  for the use of Noted's Website, located at Noted@chrisDev.com.
                </p>

                <p>
                  By accessing this website we assume you accept these terms and
                  conditions. Do not continue to use Noted if you do not agree
                ...
                <p>
                  We employ the use of cookies. By accessing Noted, you agreed
                  to use cookies in agreement with the Noted's Privacy Policy.{" "}
                </p>
                ...
                <p>
                  ...
                  from Noted for your own personal use subjected to restrictions
                ...
                <p>
                  ...
                  website. Noted does not filter, edit, publish or review
                  Comments prior to their presence on the website. Comments do
                  not reflect the views and opinions of Noted,its agents and/or
                  affiliates. Comments reflect the views and opinions of the
                  person who post their views and opinions. To the extent
                  permitted by applicable laws, Noted shall not be liable for
                ...
                <p>
                  Noted reserves the right to monitor all Comments and to remove
                ...
                <p>
                  You hereby grant Noted a non-exclusive license to use,
                ...
                <p>
                  ...
                  compensates the absence of Noted; and (d) the link is in the
                ...
                <p>
                  ...
                  inform us by sending an e-mail to Noted. Please include your
                ...
                <p>
                  No use of Noted's logo or other artwork will be allowed for
